	...
	kingsrock: {
		...
		onModifyMove(move) {
			const affectedByKingsRock = [
				...
				'crosscut', 'shadowpurge', 'shoryuken', 'dragonblast', 'slamdunk', 'kickaway', 'cheapshot',
				'hadouken', 'superkick', 'hellwheel', 'spitfire', 'wildfire', 'steelmelter', 'peckingorder',
				'miracleleaf', 'superflower', 'icicleblitz', 'partytime', 'grapple', 'twerk', 'gigapunch',
				'venomlunge', 'zenpunch', 'boulderbomb', 'pushofpike', 'cannonball',
			];
